    ...
    <main className="min-h-screen bg-dark-900 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm relative">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-white/30 text-sm mt-1.5">Admin Dashboard</p>
        </div>
        ...
        <div className="rounded-3xl border border-white/8 bg-white/[0.03] p-6 sm:p-8 shadow-2xl shadow-black/40 backdrop-blur-sm">
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              <label className="text-white/40 text-xs font-medium pl-1">Username</label>
              <input
                type="text"
                value={username}
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-white/40 text-xs font-medium pl-1">Password</label>
              <input
                type="password"
                value={password}
